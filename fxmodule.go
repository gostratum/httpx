...
func Module(opts ...Option) fx.Option {
	return fx.Options(
		...
		fx.Provide(func(log logx.Logger, v *viper.Viper, skip func(string, string) bool, obs ObservabilityParams) *gin.Engine {
			return NewEngineWithObservability(log, v, skip, obs, opts...)
		}),

		// Start the HTTP server as part of the application lifecycle
		fx.Invoke(func(lc fx.Lifecycle, v *viper.Viper, log logx.Logger, reg core.Registry, e *gin.Engine) {
